<template>
  <div id="searchText">
    ...
    <div v-if="key.length>0">
         <div class="showSearchResultsDiv">
             <div class="whiteDiv">
                 <div v-for="item in this.dataArray" :key="item.id" >
                    <div class="cellButton" @click="gotoDetailClick(item)">{{item.name}}</div>
                 </div>
    ...
    <div v-else>
          <div class="showHistoryDiv">
             <div class="titleDiv">
                 ...
                 <div class="textDiv"><div class="historyTitleSpan">历史记录</div></div>
                 <div class="cleanDiv" @click="cleanButtonClick"><div class="cleanButton" >清除</div></div>
             </div> 

          <div class="showAllHistoryDiv">
             <div class="whiteDiv">
                <div v-for="item in this.dataArray" :key="item.id" >
                   <div class="cellButton" @click="gotoDetailClick(item)">{{item.name}}</div>
                </div>
...
export default {
  ...
  methods: {
    getImgUrl(number) {
      let url = "../../../../commons/imgs/"+number+".png";
      return url;
    },
    searchButtonClick() {
      // console.log("key="+this.key);
      this.$router.push("/firstPage/searchText/speciesResults");
      if (this.key == "") {
